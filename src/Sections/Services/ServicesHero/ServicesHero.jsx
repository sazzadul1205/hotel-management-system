// src/Sections/Services/ServicesHero/ServicesHero.jsx
"use client";
...
const ServicesHero = ({ content = {} }) => {
  const {
    ...
    description = "Experience unparalleled hospitality with our comprehensive range of premium services. From rejuvenating spa treatments to state-of-the-art fitness facilities, we ensure every moment of your stay is exceptional.",
    backgroundImage = "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80",
    serviceCategories = [
      { name: "Spa & Wellness", icon: "spa", description: "Rejuvenate body & mind" },
      { name: "Fitness Center", icon: "fitness", description: "State-of-the-art equipment" },
      { name: "Swimming Pool", icon: "pool", description: "Relax & unwind" },
      { name: "Business Center", icon: "business", description: "Work efficiently" },
      { name: "Room Service", icon: "service", description: "24/7 dining" },
      { name: "Concierge", icon: "concierge", description: "Personalized assistance" },
    ],
    stats = [
      { value: "24/7", label: "Service Available", icon: "clock" },
      { value: "100+", label: "Trained Staff", icon: "users" },
      { value: "4.9", label: "Service Rating", icon: "star" },
      { value: "Award", label: "Winning Service", icon: "award" },
    ],
    primaryCta = {
  ...
  return (
    <div className="relative min-h-[60vh] w-full overflow-hidden md:min-h-[70vh] lg:min-h-[80vh]">
      ...
      <Image
        src={backgroundImage}
        alt="DA Hotel Services - Premium Hospitality"
        fill
        priority
        ...
        <div className="w-full max-w-5xl animate-fade-in-up">
          ...
          <div className="mb-3 flex items-center justify-center gap-2 md:mb-4">
            <div className="flex h-6 w-6 items-center justify-center rounded-full bg-[#FFD700]/20">
              <MdOutlineSpa className="h-3 w-3 text-[#FFD700] sm:h-3.5 sm:w-3.5" />
            </div>
          ...
          <div className="mt-6 flex items-center justify-center gap-2">
            ...
            <span className="text-xs text-gray-300">Premium Services Award 2024</span>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-4 left-1/2 hidden -translate-x-1/2 transform animate-bounce sm:bottom-6 md:block">
        ...
        <p className="mt-2 hidden text-xs text-gray-300 sm:block">Discover Services</p>
      </div>
